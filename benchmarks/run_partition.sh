#!/usr/bin/env bash
# Phase 6.2 head-to-head: hive-partition pruning across 10 files.
...
# end of the bench (Phase A2: don't trust wallclock numbers without
# verifying the file is actually parquet).
ts() { date +%s%N; }
