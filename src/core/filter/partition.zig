...
//!
//! Scope (Phase 6.2 v1): predicate must be **AND-of-leaves** where
...
//!
//! Mixed predicates (partition AND data) come in 6.2.1: split the
//! text, prune on the partition half, hand the data half to
