...
pub fn openFileWithOptions(allocator: std.mem.Allocator, path: []const u8, options: OpenOptions) !zpq.file.ParquetFile {
...
fn openS3Internal(allocator: std.mem.Allocator, path: []const u8, options: OpenOptions) !zpq.file.ParquetFile {
    ...
    const s3_src = try s3.XevS3Source.initWithOptions(
        allocator,
        host,
        bucket,
        key,
